    ...
    388: function (t, e) {
        !(function () {
            ...
            moment.range(n, o).by("days", function (n) {
                t.push({ y: Math.floor(300 * Math.random()) + 30, x: n.toDate() }),
                    e.push({ y: Math.floor(300 * Math.random()) + 10, x: n.toDate() }),
                    n.startOf("day").isSame(moment().startOf("day")) ? r.push(settings.colors.accent[500]) : r.push(settings.colors.primary[500]);
            });
            !(function (r) {
                ...
                var a = {
                    datasets: [
                        { label: "Last year", data: e, barThickness: 20 },
                        { label: "Present year", data: t, barThickness: 20 },
                    ],
                };
