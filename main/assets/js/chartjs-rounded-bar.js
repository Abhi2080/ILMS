    ...
    10: function (t, n, r) {
        var e = r(1),
            ...
            f = function (t, n, r) {
                ...
                for (a in h && (r = n), r) s = ((l = !d && x && void 0 !== x[a]) ? x : r)[a], p = b && l ? c(s, e) : y && "function" == typeof s ? c(Function.call, s) : s, x && u(x, a, s, t & f.U), g[a] != s && i(g, a, p), y && m[a] != s && (m[a] = s)
            };
    ...
    424: function (t, n, r) {
        ...
        Chart.elements.RoundedTopRectangle = Chart.elements.Rectangle.extend({
            draw: function () {
                ...
                var y = Math.abs(t - n),
                    b = r,
                    x = (r = b + y * (this._chart.config.options.barRoundness || .5) * .5) - b;
                c.beginPath(), c.fillStyle = f.backgroundColor, c.strokeStyle = f.borderColor, c.lineWidth = a,
                    ...
                    }(c, t, r - x + 1, y, e - b, x), c.fill(), a && c.stroke(), r = b
            }
